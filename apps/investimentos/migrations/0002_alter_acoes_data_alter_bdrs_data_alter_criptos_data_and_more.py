...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='acoes',
            name='data',
            field=models.DateField(default=datetime.date(2023, 8, 24), validators=[django.core.validators.MaxValueValidator(datetime.date(2023, 8, 24))]),
        ),
        migrations.AlterField(
            model_name='bdrs',
            name='data',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.DateField(default=datetime.date(2023, 8, 24), validators=[django.core.validators.MaxValueValidator(datetime.date(2023, 8, 24))])),
